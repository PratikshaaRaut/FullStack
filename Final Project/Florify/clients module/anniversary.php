...
<div class="container-fluid" style="background-color: white; position: relative; z-index: 1;">
  <div class="text-center" style="padding: 30px 0;">
    ...
    <p>Celebrate Anniversary with bright, beautiful blooms. Choose from our Anniversaryy-special arrangements!</p>
  </div>

  <?php
  $con = mysqli_connect("localhost", "root", "", "florifydb");
  $qry = "SELECT * FROM product WHERE product_type='Anniversary'";
